...
export function MetricCard({
  ...
  const getValueColor = () => {
    if (valueColor === "profit") return "text-green-600";
    if (valueColor === "loss") return "text-red-600";
  ...
  return (
    <Card
      className={cn(
        "border-0 shadow-md bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50 hover:shadow-lg transition-shadow",
        className,
      )}
    >
